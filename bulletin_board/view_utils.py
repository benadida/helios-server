...
def render_template(request, template_name, vars = {}, include_user=True):
  ...
  return render_to_response('bulletin_board/templates/bulletin_board/%s.html' % template_name, vars_with_user)
  
def render_template_threshold(request, template_name, vars = {}, include_user=True):
  #t = loader.get_template(template_name + '.html')
  ...
  return render_to_response('heliosthreshold/templates/%s.html' % template_name, vars_with_user)
