...
class Polynomial():
    ...
    def __init__(self,c0=None,scheme=None,EG=None):
        ...
        for i in range(self.grade):
            self.coeff.append(Utils.random_mpz_lt(q)) # Dit moet p-1 zijn!!? werkt niet met p..? fout?
...
class Encrypted_Share():
    ...
    def decrypt(self,secret_key):
        point_s = self.encry_point_s.decrypt(secret_key)  #select only the value
        ...
        for i in range(1,k+1):
            ...
            for j in range(1,k+1):
                ...
                if j==i:
                    ...
                    fact = Fraction(numerator=-pointj.x_value, denominator=(pointi.x_value-pointj.x_value))#%p
