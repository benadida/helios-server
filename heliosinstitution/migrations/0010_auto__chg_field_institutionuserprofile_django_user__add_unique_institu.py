...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstitutionUserProfile.django_user'
        db.alter_column(u'heliosinstitution_institutionuserprofile', 'django_user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'InstitutionUserProfile', fields ['django_user']
        db.create_unique(u'heliosinstitution_institutionuserprofile', ['django_user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'InstitutionUserProfile', fields ['django_user']
        db.delete_unique(u'heliosinstitution_institutionuserprofile', ['django_user_id'])


        # Changing field 'InstitutionUserProfile.django_user'
        db.alter_column(u'heliosinstitution_institutionuserprofile', 'django_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
