...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'heliosinstitution_institution', 'mngt_email')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Institution.mngt_email'
        raise RuntimeError("Cannot reverse this migration. 'Institution.mngt_email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Institution.mngt_email'
        db.add_column(u'heliosinstitution_institution', 'mngt_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, unique=True),
                      keep_default=False)
