...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstitutionUserProfile.django_user'
        db.add_column(u'heliosinstitution_institutionuserprofile', 'django_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstitutionUserProfile.django_user'
        db.delete_column(u'heliosinstitution_institutionuserprofile', 'django_user_id')
    ...
    models = {
        ...
        u'heliosinstitution.institutionuserprofile': {
            ...
            'django_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
