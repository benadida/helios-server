...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institution.upload_voters'
        db.add_column(u'heliosinstitution_institution', 'upload_voters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Institution.upload_voters'
        db.delete_column(u'heliosinstitution_institution', 'upload_voters')
