...
class OAuthRequest(object):
    ...
    OAUTH_PARAMS = ['oauth_consumer_key', 'oauth_token', 'oauth_signature_method',
    ...
    # return a string that consists of all the parameters that need to be
    # signed
    ...
    # util function: turn Authorization: header into parameters, has to do
    # some unescaping
    @staticmethod
