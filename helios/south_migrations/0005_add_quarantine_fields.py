...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('helios_election', 'complaint_period_ends_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)

        # Adding field 'CastVote.quarantined_p'
        db.add_column('helios_castvote', 'quarantined_p',
