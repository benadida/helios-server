...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column('helios_voterfile', 'voter_file_content', self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Changing field 'VoterFile.voter_file'
        db.alter_column('helios_voterfile', 'voter_file',
                        self.gf('django.db.models.fields.files.FileField')(max_length=250, null=True))
