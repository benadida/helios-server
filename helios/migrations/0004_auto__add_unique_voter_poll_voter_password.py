...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Voter', fields ['poll', 'voter_password']
        db.create_unique('helios_voter', ['poll_id', 'voter_password'])


    def backwards(self, orm):
        # Removing unique constraint on 'Voter', fields ['poll', 'voter_password']
        db.delete_unique('helios_voter', ['poll_id', 'voter_password'])
