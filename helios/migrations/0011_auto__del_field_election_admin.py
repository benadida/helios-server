...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.admin'
        db.delete_column('helios_election', 'admin_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Election.admin'
        raise RuntimeError("Cannot reverse this migration. 'Election.admin' and its values cannot be restored.")
    ...
    models = {
        ...
        'helios.election': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['heliosauth.User']", 'symmetrical': 'False'}),
