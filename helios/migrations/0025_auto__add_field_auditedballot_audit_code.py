...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuditedBallot.audit_code'
        db.add_column('helios_auditedballot', 'audit_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuditedBallot.audit_code'
        db.delete_column('helios_auditedballot', 'audit_code')
