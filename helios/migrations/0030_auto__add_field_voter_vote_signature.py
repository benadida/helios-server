...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.vote_signature'
        db.add_column('helios_voter', 'vote_signature',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.vote_signature'
        db.delete_column('helios_voter', 'vote_signature')
