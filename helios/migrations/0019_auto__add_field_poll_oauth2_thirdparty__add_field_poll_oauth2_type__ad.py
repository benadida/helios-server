...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('helios_poll', 'jwt_auth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Poll.jwt_public_key'
        db.add_column('helios_poll', 'jwt_public_key',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Poll.jwt_issuer'
        db.add_column('helios_poll', 'jwt_issuer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.oauth2_thirdparty'
        db.delete_column('helios_poll', 'oauth2_thirdparty')

        # Deleting field 'Poll.oauth2_type'
        db.delete_column('helios_poll', 'oauth2_type')

        # Deleting field 'Poll.oauth2_client_type'
        db.delete_column('helios_poll', 'oauth2_client_type')

        # Deleting field 'Poll.oauth2_client_id'
        db.delete_column('helios_poll', 'oauth2_client_id')

        # Deleting field 'Poll.oauth2_client_secret'
        db.delete_column('helios_poll', 'oauth2_client_secret')

        # Deleting field 'Poll.oauth2_code_url'
        db.delete_column('helios_poll', 'oauth2_code_url')

        # Deleting field 'Poll.oauth2_exchange_url'
        db.delete_column('helios_poll', 'oauth2_exchange_url')

        # Deleting field 'Poll.oauth2_confirmation_url'
        db.delete_column('helios_poll', 'oauth2_confirmation_url')

        # Deleting field 'Poll.oauth2_extra'
        db.delete_column('helios_poll', 'oauth2_extra')

        # Deleting field 'Poll.jwt_auth'
        db.delete_column('helios_poll', 'jwt_auth')

        # Deleting field 'Poll.jwt_public_key'
        db.delete_column('helios_poll', 'jwt_public_key')

        # Deleting field 'Poll.jwt_issuer'
        db.delete_column('helios_poll', 'jwt_issuer')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'official': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 9, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 8, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
        ...
        'helios.poll': {
            ...
            'jwt_auth': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'jwt_issuer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'jwt_public_key': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'oauth2_client_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_client_secret': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_client_type': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'oauth2_code_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_confirmation_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_exchange_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_extra': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'oauth2_thirdparty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'oauth2_type': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
        ...
        'helios.voter': {
            ...
            'last_sms_code': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
