...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.last_sms_send_at'
        db.add_column('helios_voter', 'last_sms_send_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.last_sms_send_at'
        db.delete_column('helios_voter', 'last_sms_send_at')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
