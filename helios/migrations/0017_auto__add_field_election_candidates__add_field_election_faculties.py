...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.candidates'
        db.add_column('helios_election', 'candidates',
    ...
    def backwards(self, orm):
        # Deleting field 'Election.candidates'
        db.delete_column('helios_election', 'candidates')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'candidates': ('heliosauth.jsonfield.JSONField', [], {}),
            ...
            'faculties': ('heliosauth.jsonfield.JSONField', [], {}),
