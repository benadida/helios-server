...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poll.stv__results'
        db.delete_column('helios_poll', 'stv__results')
    ...
    def backwards(self, orm):
        # Adding field 'Poll.stv__results'
        db.add_column('helios_poll', 'stv__results',
                      self.gf('heliosauth.jsonfield.JSONField')(null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 12, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 11, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
