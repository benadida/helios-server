...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.mixing_finished_at'
        db.add_column('helios_election', 'mixing_finished_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.mixing_finished_at'
        db.delete_column('helios_election', 'mixing_finished_at')
