...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CastVote.previous'
        db.add_column('helios_castvote', 'previous',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CastVote.previous'
        db.delete_column('helios_castvote', 'previous')
    ...
    models = {
        ...
        'helios.castvote': {
            ...
            'previous': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
