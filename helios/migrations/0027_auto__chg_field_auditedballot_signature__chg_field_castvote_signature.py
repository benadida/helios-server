...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuditedBallot.signature'
        db.alter_column('helios_auditedballot', 'signature', self.gf('heliosauth.jsonfield.JSONField')(null=True))

        # Changing field 'CastVote.signature'
        db.alter_column('helios_castvote', 'signature', self.gf('heliosauth.jsonfield.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'AuditedBallot.signature'
        db.alter_column('helios_auditedballot', 'signature', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CastVote.signature'
        db.alter_column('helios_castvote', 'signature', self.gf('django.db.models.fields.TextField')())
