...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ElectionMixnet.mix_file'
        db.alter_column('helios_electionmixnet', 'mix_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ElectionMixnet.mix_file'
        raise RuntimeError("Cannot reverse this migration. 'ElectionMixnet.mix_file' and its values cannot be restored.")
    ...
    models = {
        ...
        'helios.electionmixnet': {
            ...
            'mix_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
