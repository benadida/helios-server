...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.departments'
        db.add_column('helios_election', 'departments',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'Poll.stv_results'
        db.add_column('helios_poll', 'stv_results',
                      self.gf('heliosauth.jsonfield.JSONField')(null=True),
                      keep_default=False)

        # Adding field 'Poll.eligibles_count'
        db.add_column('helios_poll', 'eligibles_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Poll.has_department_limit'
        db.add_column('helios_poll', 'has_department_limit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.departments'
        db.delete_column('helios_election', 'departments')

        # Deleting field 'Poll.stv_results'
        db.delete_column('helios_poll', 'stv_results')

        # Deleting field 'Poll.eligibles_count'
        db.delete_column('helios_poll', 'eligibles_count')

        # Deleting field 'Poll.has_department_limit'
        db.delete_column('helios_poll', 'has_department_limit')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 30, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 29, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
