...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.ecounting_request_error'
        db.add_column('helios_election', 'ecounting_request_error',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.ecounting_request_error'
        db.delete_column('helios_election', 'ecounting_request_error')
