...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AuditedBallot', fields ['is_request', 'election', 'fingerprint']
        db.create_unique('helios_auditedballot', ['is_request', 'election_id', 'fingerprint'])


    def backwards(self, orm):
        # Removing unique constraint on 'AuditedBallot', fields ['is_request', 'election', 'fingerprint']
        db.delete_unique('helios_auditedballot', ['is_request', 'election_id', 'fingerprint'])
