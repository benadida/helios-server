...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.excluded_at'
        db.add_column('helios_voter', 'excluded_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Voter.exclude_reason'
        db.add_column('helios_voter', 'exclude_reason',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.excluded_at'
        db.delete_column('helios_voter', 'excluded_at')

        # Deleting field 'Voter.exclude_reason'
        db.delete_column('helios_voter', 'exclude_reason')
