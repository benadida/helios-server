...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.voter_fathername'
        db.add_column('helios_voter', 'voter_fathername',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.voter_fathername'
        db.delete_column('helios_voter', 'voter_fathername')
