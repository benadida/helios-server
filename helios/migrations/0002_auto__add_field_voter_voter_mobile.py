...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.voter_mobile'
        db.add_column('helios_voter', 'voter_mobile',
                      self.gf('django.db.models.fields.CharField')(max_length=48, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.voter_mobile'
        db.delete_column('helios_voter', 'voter_mobile')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 17, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 16, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
