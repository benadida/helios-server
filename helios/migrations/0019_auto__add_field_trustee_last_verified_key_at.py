...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trustee.last_verified_key_at'
        db.add_column('helios_trustee', 'last_verified_key_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trustee.last_verified_key_at'
        db.delete_column('helios_trustee', 'last_verified_key_at')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'faculties': ('heliosauth.jsonfield.JSONField', [], {'default': "'[]'"}),
