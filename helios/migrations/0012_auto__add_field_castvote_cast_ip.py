...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CastVote.cast_ip'
        db.add_column('helios_castvote', 'cast_ip',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CastVote.cast_ip'
        db.delete_column('helios_castvote', 'cast_ip')
    ...
    models = {
        ...
        'helios.castvote': {
            ...
            'cast_ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
