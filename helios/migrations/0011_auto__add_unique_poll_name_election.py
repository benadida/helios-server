...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Poll', fields ['name', 'election']
        db.create_unique('helios_poll', ['name', 'election_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Poll', fields ['name', 'election']
        db.delete_unique('helios_poll', ['name', 'election_id'])
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 17, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
