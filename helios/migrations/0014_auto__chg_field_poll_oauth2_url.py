...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.oauth2_url'
        db.alter_column('helios_poll', 'oauth2_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Poll.oauth2_url'
        db.alter_column('helios_poll', 'oauth2_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 8, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
