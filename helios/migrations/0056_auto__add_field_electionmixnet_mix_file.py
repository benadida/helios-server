...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectionMixnet.mix_file'
        db.add_column('helios_electionmixnet', 'mix_file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectionMixnet.mix_file'
        db.delete_column('helios_electionmixnet', 'mix_file')
    ...
    models = {
        ...
        'helios.electionmixnet': {
            ...
            'mix_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
