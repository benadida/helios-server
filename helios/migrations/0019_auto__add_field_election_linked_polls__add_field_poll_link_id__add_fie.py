...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.linked_polls'
        db.add_column('helios_election', 'linked_polls',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Poll.link_id'
        db.add_column('helios_poll', 'link_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Poll.linked_ref'
        db.add_column('helios_poll', 'linked_ref',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Poll.index'
        db.add_column('helios_poll', 'index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Poll.jtw_auth'
        db.add_column('helios_poll', 'jtw_auth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.linked_polls'
        db.delete_column('helios_election', 'linked_polls')

        # Deleting field 'Poll.link_id'
        db.delete_column('helios_poll', 'link_id')

        # Deleting field 'Poll.linked_ref'
        db.delete_column('helios_poll', 'linked_ref')

        # Deleting field 'Poll.index'
        db.delete_column('helios_poll', 'index')

        # Deleting field 'Poll.jtw_auth'
        db.delete_column('helios_poll', 'jtw_auth')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 14, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
        ...
        'helios.poll': {
            ...
            'jtw_auth': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
