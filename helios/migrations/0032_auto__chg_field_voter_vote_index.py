...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Voter.vote_index'
        db.alter_column('helios_voter', 'vote_index', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Voter.vote_index'
        raise RuntimeError("Cannot reverse this migration. 'Voter.vote_index' and its values cannot be restored.")
