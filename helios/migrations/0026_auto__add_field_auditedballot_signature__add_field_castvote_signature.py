...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuditedBallot.signature'
        db.add_column('helios_auditedballot', 'signature',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'CastVote.signature'
        db.add_column('helios_castvote', 'signature',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AuditedBallot.signature'
        db.delete_column('helios_auditedballot', 'signature')

        # Deleting field 'CastVote.signature'
        db.delete_column('helios_castvote', 'signature')
