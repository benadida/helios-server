...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElectionMixnet.second_mix'
        db.add_column('helios_electionmixnet', 'second_mix',
                      self.gf('heliosauth.jsonfield.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElectionMixnet.second_mix'
        db.delete_column('helios_electionmixnet', 'second_mix')
