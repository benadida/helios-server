...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.email_language'
        db.delete_column('helios_election', 'email_language')

        # Adding field 'Election.communication_language'
        db.add_column('helios_election', 'communication_language',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Election.email_language'
        db.add_column('helios_election', 'email_language',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)

        # Deleting field 'Election.communication_language'
        db.delete_column('helios_election', 'communication_language')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 6, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 5, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
