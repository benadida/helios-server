...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.zeus_fingerprint'
        db.add_column('helios_election', 'zeus_fingerprint',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.zeus_fingerprint'
        db.delete_column('helios_election', 'zeus_fingerprint')
