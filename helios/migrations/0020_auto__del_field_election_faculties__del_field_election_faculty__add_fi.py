...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.faculties'
        db.delete_column('helios_election', 'faculties')

        # Deleting field 'Election.faculty'
        db.delete_column('helios_election', 'faculty_id')

        # Adding field 'Election.institution'
        db.add_column('helios_election', 'institution',
        ...
        db.add_column('helios_election', 'departments',
                      self.gf('heliosauth.jsonfield.JSONField')(default='[]'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Election.faculties'
        db.add_column('helios_election', 'faculties',
                      self.gf('heliosauth.jsonfield.JSONField')(default='[]'),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Election.faculty'
        raise RuntimeError("Cannot reverse this migration. 'Election.faculty' and its values cannot be restored.")
        # Deleting field 'Election.institution'
        db.delete_column('helios_election', 'institution_id')
