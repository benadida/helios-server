...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.shibboleth_auth'
        db.add_column('helios_poll', 'shibboleth_auth',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Poll.shibboleth_constraints'
        db.add_column('helios_poll', 'shibboleth_constraints',
                      self.gf('heliosauth.jsonfield.JSONField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.shibboleth_auth'
        db.delete_column('helios_poll', 'shibboleth_auth')

        # Deleting field 'Poll.shibboleth_constraints'
        db.delete_column('helios_poll', 'shibboleth_constraints')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 10, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 9, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
        ...
        'helios.poll': {
            ...
            'shibboleth_auth': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'shibboleth_constraints': ('heliosauth.jsonfield.JSONField', [], {'default': 'None', 'null': 'True'}),
            'short_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
