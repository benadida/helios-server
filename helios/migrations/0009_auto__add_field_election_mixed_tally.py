...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.mixed_tally'
        db.add_column('helios_election', 'mixed_tally',
                      self.gf('helios.datatypes.djangofield.LDObjectField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.mixed_tally'
        db.delete_column('helios_election', 'mixed_tally')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mixed_tally': ('helios.datatypes.djangofield.LDObjectField', [], {'null': 'True'}),
