...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CastVote.election'
        db.add_column('helios_castvote', 'election',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['helios.Election']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CastVote.election'
        db.delete_column('helios_castvote', 'election_id')
    ...
    models = {
        ...
        'helios.auditedballotrequest': {
            'Meta': {'object_name': 'AuditedBallotRequest'},
            'added_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'election': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['helios.Election']"}),
            'fingerprint': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
