...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MixParts'
        db.create_table('helios_mixparts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mixnet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parts', to=orm['helios.ElectionMixnet'])),
            ('mix', self.gf('helios.byte_fields.ByteaField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('helios', ['MixParts'])


    def backwards(self, orm):
        # Deleting model 'MixParts'
        db.delete_table('helios_mixparts')
