...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.is_completed'
        db.add_column('helios_election', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.is_completed'
        db.delete_column('helios_election', 'is_completed')
