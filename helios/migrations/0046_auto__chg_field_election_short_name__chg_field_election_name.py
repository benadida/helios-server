...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Election.short_name'
        db.alter_column('helios_election', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Election.name'
        db.alter_column('helios_election', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Election.short_name'
        db.alter_column('helios_election', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Election.name'
        db.alter_column('helios_election', 'name', self.gf('django.db.models.fields.CharField')(max_length=110))
