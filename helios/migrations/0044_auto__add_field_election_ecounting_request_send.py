...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.ecounting_request_send'
        db.add_column('helios_election', 'ecounting_request_send',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.ecounting_request_send'
        db.delete_column('helios_election', 'ecounting_request_send')
