...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.eligibles_count'
        db.add_column('helios_election', 'eligibles_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Election.has_department_limit'
        db.add_column('helios_election', 'has_department_limit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.eligibles_count'
        db.delete_column('helios_election', 'eligibles_count')

        # Deleting field 'Election.has_department_limit'
        db.delete_column('helios_election', 'has_department_limit')
