...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.send_email_on_cast_done'
        db.add_column('helios_election', 'send_email_on_cast_done',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.send_email_on_cast_done'
        db.delete_column('helios_election', 'send_email_on_cast_done')
