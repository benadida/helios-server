...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.audit_passwords'
        db.add_column('helios_voter', 'audit_passwords',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.audit_passwords'
        db.delete_column('helios_voter', 'audit_passwords')
