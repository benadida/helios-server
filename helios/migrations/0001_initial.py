    ...
    def forwards(self, orm):
        ...
        db.create_table('helios_election', (
            ('id', self.gf('django.db.models.fields.AutoField')
             (primary_key=True)),
            ('admin', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['helios_auth.User'])),
            ...
            ('public_key', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('private_key', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('questions', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('eligibility', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('openreg', self.gf('django.db.models.fields.BooleanField')
             (default=False)),
            ('featured_p', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('use_voter_aliases', self.gf(
                'django.db.models.fields.BooleanField')(default=False)),
            ('cast_url', self.gf('django.db.models.fields.CharField')
             (max_length=500)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('frozen_at', self.gf('django.db.models.fields.DateTimeField')
             (default=None, null=True)),
            ('archived_at', self.gf('django.db.models.fields.DateTimeField')
             (default=None, null=True)),
            ('registration_starts_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('voting_starts_at', self.gf('django.db.models.fields.DateTimeField')(
                default=None, null=True)),
            ('voting_ends_at', self.gf('django.db.models.fields.DateTimeField')(
                default=None, null=True)),
            ('tallying_starts_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('voting_started_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('voting_extended_until', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('voting_ended_at', self.gf('django.db.models.fields.DateTimeField')(
                default=None, null=True)),
            ('tallying_started_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('tallying_finished_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('tallies_combined_at', self.gf(
                'django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('voters_hash', self.gf('django.db.models.fields.CharField')
             (max_length=100, null=True)),
            ('encrypted_tally', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('result', self.gf('helios_auth.jsonfield.JSONField')(null=True)),
            ('result_proof', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
        ))
        ...
        db.create_table('helios_voterfile', (
            ...
            ('election', self.gf('django.db.models.fields.related.ForeignKey')
             (to=orm['helios.Election'])),
            ('voter_file', self.gf(
                'django.db.models.fields.files.FileField')(max_length=250)),
            ('uploaded_at', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('processing_started_at', self.gf(
                'django.db.models.fields.DateTimeField')(null=True)),
            ('processing_finished_at', self.gf(
                'django.db.models.fields.DateTimeField')(null=True)),
            ('num_voters', self.gf(
        ...
        db.create_table('helios_voter', (
            ...
            ('voter_type', self.gf(
                'django.db.models.fields.CharField')(max_length=100)),
            ('voter_id', self.gf('django.db.models.fields.CharField')
             (max_length=100)),
            ('uuid', self.gf('django.db.models.fields.CharField')
             (max_length=50)),
            ...
            ('vote_hash', self.gf('django.db.models.fields.CharField')
             (max_length=100, null=True)),
            ('cast_at', self.gf(
                'django.db.models.fields.DateTimeField')(null=True)),
        ))
        ...
        db.create_table('helios_castvote', (
            ...
            ('vote_hash', self.gf(
                'django.db.models.fields.CharField')(max_length=100)),
            ('cast_at', self.gf('django.db.models.fields.DateTimeField')
             (auto_now_add=True, blank=True)),
            ('verified_at', self.gf(
                'django.db.models.fields.DateTimeField')(null=True)),
            ('invalidated_at', self.gf(
                'django.db.models.fields.DateTimeField')(null=True)),
        ))
        ...
        db.create_table('helios_trustee', (
            ...
            ('public_key', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('public_key_hash', self.gf(
                'django.db.models.fields.CharField')(max_length=100)),
            ('secret_key', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('pok', self.gf('helios_auth.jsonfield.JSONField')(null=True)),
            ('decryption_factors', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
            ('decryption_proofs', self.gf(
                'helios_auth.jsonfield.JSONField')(null=True)),
        ))
