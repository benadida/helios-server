...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.canceled'
        db.delete_column('helios_election', 'canceled')

        # Adding field 'Election.canceled_at'
        db.add_column('helios_election', 'canceled_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Election.canceled'
        db.add_column('helios_election', 'canceled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Election.canceled_at'
        db.delete_column('helios_election', 'canceled_at')
