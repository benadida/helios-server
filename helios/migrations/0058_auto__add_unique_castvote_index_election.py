...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CastVote', fields ['index', 'election']
        db.create_unique('helios_castvote', ['index', 'election_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CastVote', fields ['index', 'election']
        db.delete_unique('helios_castvote', ['index', 'election_id'])
