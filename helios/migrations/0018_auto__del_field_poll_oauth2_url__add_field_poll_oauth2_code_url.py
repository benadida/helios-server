...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poll.oauth2_url'
        db.delete_column('helios_poll', 'oauth2_url')
    ...
    def backwards(self, orm):
        # Adding field 'Poll.oauth2_url'
        db.add_column('helios_poll', 'oauth2_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 21, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 20, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
