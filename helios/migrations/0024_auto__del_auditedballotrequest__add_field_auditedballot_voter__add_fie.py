...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'AuditedBallotRequest'
        db.delete_table('helios_auditedballotrequest')

        # Adding field 'AuditedBallot.voter'
        db.add_column('helios_auditedballot', 'voter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['helios.Voter'], null=True),
                      keep_default=False)

        # Adding field 'AuditedBallot.is_request'
        db.add_column('helios_auditedballot', 'is_request',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'AuditedBallotRequest'
        db.create_table('helios_auditedballotrequest', (
        ...
        db.send_create_signal('helios', ['AuditedBallotRequest'])

        # Deleting field 'AuditedBallot.voter'
        db.delete_column('helios_auditedballot', 'voter_id')

        # Deleting field 'AuditedBallot.is_request'
        db.delete_column('helios_auditedballot', 'is_request')
