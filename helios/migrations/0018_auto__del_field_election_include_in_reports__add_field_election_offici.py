...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.include_in_reports'
        db.delete_column('helios_election', 'include_in_reports')

        # Adding field 'Election.official'
        db.add_column('helios_election', 'official',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Election.include_in_reports'
        db.add_column('helios_election', 'include_in_reports',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Election.official'
        db.delete_column('helios_election', 'official')
    ...
    models = {
        ...
        'helios.election': {
            ...
            'voting_ends_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 13, 0, 0)', 'null': 'True'}),
            'voting_extended_until': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'voting_starts_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 13, 0, 0)', 'null': 'True'})
        },
        'helios.electionlog': {
