...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.remote_mixnets_stopped_at'
        db.delete_column('helios_election', 'remote_mixnets_stopped_at')

        # Adding field 'Election.remote_mixnets_finished_at'
        db.add_column('helios_election', 'remote_mixnets_finished_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Election.remote_mixnets_stopped_at'
        db.add_column('helios_election', 'remote_mixnets_stopped_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Deleting field 'Election.remote_mixnets_finished_at'
        db.delete_column('helios_election', 'remote_mixnets_finished_at')
