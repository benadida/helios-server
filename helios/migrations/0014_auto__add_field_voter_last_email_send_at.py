...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.last_email_send_at'
        db.add_column('helios_voter', 'last_email_send_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.last_email_send_at'
        db.delete_column('helios_voter', 'last_email_send_at')
