...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MixedAnswers.shuffling_proof'
        db.delete_column('helios_mixedanswers', 'shuffling_proof')

        # Deleting field 'MixedAnswers.mixed_answers'
        db.delete_column('helios_mixedanswers', 'mixed_answers')


    def backwards(self, orm):
        # Adding field 'MixedAnswers.shuffling_proof'
        db.add_column('helios_mixedanswers', 'shuffling_proof',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'MixedAnswers.mixed_answers'
        db.add_column('helios_mixedanswers', 'mixed_answers',
    ...
    models = {
        ...
        'helios.mixedanswers': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mix': ('heliosauth.jsonfield.JSONField', [], {}),
