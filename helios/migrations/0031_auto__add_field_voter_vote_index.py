...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voter.vote_index'
        db.add_column('helios_voter', 'vote_index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voter.vote_index'
        db.delete_column('helios_voter', 'vote_index')
    ...
    models = {
        ...
        'helios.voter': {
            ...
            'vote_index': ('django.db.models.fields.PositiveIntegerField', [], {}),
