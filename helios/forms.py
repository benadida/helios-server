...
class ElectionForm(forms.Form):
    ...
    voting_ends_at = forms.DateTimeField(required=False, label='Votin Ends at', widget=forms.TextInput(attrs={'class': 'datetimepicker', 'data-help': 'Date and time when voting ends.'}))
