...
class ElectionForm(forms.Form):
    ...
    faculties = forms.CharField(widget=forms.Textarea,
                label=_('Schools and Departments'),
                help_text=_('University Schools. e.g. <br/><br/> School of Engineering <br />'
                            'School of Medicine<br />School of Informatics<br />'))

    help_email = forms.EmailField(label=_('Help email'),
                help_text=_('Voters can contact this email for election suport'))
    help_phone = forms.CharField(label=_('Help phone'),
                help_text=_('Voters can contact this phone for election suport'))
        ...
        if is_new or not election.frozen_at:
            ...
            if e.candidates:
                ...
                if len(new_cands) != len(e.candidates):
                    messages.warning(_("Election candidates changed due to schools"
                                       " changing"))
