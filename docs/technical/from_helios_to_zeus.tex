...
after decryption''.
We subsequently addressed this for any submited ciphertext $(g^r, c_2)$
by including $c_2$ in the hash that produces the challenge for the proof
of knowledge of $r$. This way, the proof of knowlegde is bound to the
specific ciphertext and therefore is not reusable.
