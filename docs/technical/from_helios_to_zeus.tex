...
Although the prime impetus was to support preference elections,
it was later required of Zeus to support simple approval elections,
where voters simply select alternatives without specifying
