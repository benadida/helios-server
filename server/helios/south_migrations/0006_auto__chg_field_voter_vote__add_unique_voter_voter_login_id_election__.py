...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(
            "helios_castvote",
            "vote",
            self.gf("helios.datatypes.djangofield.LDObjectField")(),
        )
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            "helios_voter",
            "vote",
            self.gf("helios_auth.jsonfield.JSONField")(null=True),
        )
    ...
    models = {
        ...
        "helios.election": {
            ...
            "datatype": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'legacy/Election'", "max_length": "250"},
            ),
            "description": ("django.db.models.fields.TextField", [], {}),
            "election_type": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'election'", "max_length": "250"},
            ),
            "eligibility": (
        ...
        "helios.voter": {
            ...
            "user": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"to": "orm['helios_auth.User']", "null": "True"},
            ),
            "uuid": ("django.db.models.fields.CharField", [], {"max_length": "50"}),
            "vote": (
                "helios.datatypes.djangofield.LDObjectField",
